...
parser.add_option("--arch", dest="arch", help="Unet", default="SegNet", type="string")
...
model_path = "./trained_weights/SegNet" + str(model_path_idx) + "/"
...
def SegNet(input_shape=(128, 128, 3), classes=1):
