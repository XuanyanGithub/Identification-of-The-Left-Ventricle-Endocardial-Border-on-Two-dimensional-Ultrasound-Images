...
parser.add_option("--arch", dest="arch", help="Unet", default="FCN", type="string")
parser.add_option("--init", dest="init", help="random | finetune", default="random", type="string")
parser.add_option("--backbone", dest="backbone", help="the backbones", default="vgg16", type="string")
...
model_path = "./trained_weights/FCN" + str(model_path_idx) + "/"
...
def fcn_8s(num_classes, input_shape,  vgg_weight_path=None):
    ...
    return model
vgg_path='/home/xuanyan/python_worker/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5'
model = fcn_8s(input_shape=(128, 128, 3), num_classes=1,
